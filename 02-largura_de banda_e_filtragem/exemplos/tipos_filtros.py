...
class tipos_filtros(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Tipos de filtros", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Tipos de filtros")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "tipos_filtros")
        ...
        self._noise_amp_win = qtgui.RangeWidget(self._noise_amp_range, self.set_noise_amp, "Noise Amplitude", "counter", float, QtCore.Qt.Horizontal)
        ...
        self.top_grid_layout.addWidget(self._qtgui_freq_sink_x_2_win, 1, 0, 1, 1)
        for r in range(1, 2):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(0, 1):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.band_pass_filter_0 = filter.fir_filter_fff(
            ...
            firdes.band_pass(
                ...
                window.WIN_HAMMING,
                6.76))
        self.analog_noise_source_x_0 = analog.noise_source_f(analog.GR_UNIFORM, noise_amp, 0)
        ...
        self.connect((self.high_pass_filter_0, 0), (self.qtgui_freq_sink_x_2, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.band_pass_filter_0.set_taps(firdes.band_pass(1, self.samp_rate, 5000, 10000, 100, window.WIN_HAMMING, 6.76))
        self.high_pass_filter_0.set_taps(firdes.high_pass(1, self.samp_rate, 5000, 100, window.WIN_HAMMING, 6.76))
...
def main(top_block_cls=tipos_filtros, options=None):
