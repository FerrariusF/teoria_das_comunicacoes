...
class sinais_ortogonais(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Sinais ortogonais", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Sinais ortogonais")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "sinais_ortogonais")
        ...
        self.analog_sig_source_x_0_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 20, 1, 0, 0)
        ...
        self.connect((self.high_pass_filter_0, 0), (self.qtgui_time_sink_x_1_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.high_pass_filter_0.set_taps(firdes.high_pass(1, self.samp_rate, 12, 2, window.WIN_HANN, 6.76))
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 12, 2, window.WIN_HAMMING, 6.76))
...
def main(top_block_cls=sinais_ortogonais, options=None):
