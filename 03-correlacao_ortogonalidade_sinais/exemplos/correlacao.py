...
class correlacao(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Correlação de Sinais", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Correlação de Sinais")
        ...
        self.qtgui_time_sink_x_2.set_y_axis(0, 6)
        ...
        self.qtgui_time_sink_x_1.set_y_axis(0, 6)
        ...
        self.connect((self.digital_corr_est_cc_0, 1), (self.qtgui_time_sink_x_2, 0))
...
def main(top_block_cls=correlacao, options=None):
